          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-5 rounded-[1.4rem] border border-white/10 bg-[#0d1117] px-4 py-4">
              ...
              <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="rounded-full border border-white/10 bg-white/3 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-slate-300">
                  {confidenceLabel}
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[1.4rem] border border-white/10 bg-[#0d1117] p-4">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-transparent px-4 py-3 text-sm font-semibold text-slate-200 transition hover:border-slate-300/20 hover:bg-white/3"
                >
